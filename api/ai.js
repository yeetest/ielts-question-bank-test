...
Keep the whole JSON assessment concise: all "comments" text combined within about 600 words total. Do not pad length; avoid praise-only. For every criterion where band is below 9, explain the gap against Band 9 for that same criterion (May 2023 descriptors) — what Band 9 expects vs what this essay does. Band 9 is always the reference for "why not higher"; do not anchor the explanation on Band 8 or on "the band below" the award. If band is 9, briefly note fit with Band 9 or extremely rare lapses only. Quote descriptor wording sparingly when it helps; no need to paste full bands. The JSON must be fully complete; never stop mid-string or mid-value.
