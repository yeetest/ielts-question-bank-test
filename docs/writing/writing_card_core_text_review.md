...
### 1. itongzhuo-2961
Source title: `G20 Test4 Part1`
Full prompt:
```text
You recently used a company to help you move your furniture and possessions to your new apartment. The removal company has now asked for your feedback about the service they provided.
...
Full prompt:
```text
You work for an entertainment company which plans to open a new theatre soon. You want to invite a famous actor to open the new theatre.
...
### 1. itongzhuo-2962
Source title: `G20 Test4 Part2`
Full prompt:
```text
Write about the following topic:

In some parts of the world, people buy far too many clothes.

What are the reasons for this?

How can people be persuaded to reduce the number of clothes they buy?

Give reasons for your answer and include any relevant examples from your own knowledge or experi ence.
...
Full prompt:
```text
Nowadays it's possible for people to buy many products or pay for treatments that help them to look younger.
...
In many countries, family members work together in their family business.
...
It is important for children, young adults, working people and the retired to have at least one hobby.
...
ls this a positive or a negative development?
...
Which other types of job should he highly paid?
...
Full prompt:
```text
Some people believe that unpaid community service should be a compulsory part of high school programmes (for example working for a charity, improving the neighbourhood or teaching sports fo younger children).
