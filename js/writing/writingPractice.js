        ...
        <section class="writing-pane writing-pane-right" id="writing-result-pane">
          ${workspace.correctionResult ? `
            ...
            <div class="writing-tab-panel">
              ...
              ${workspace.activeTab === 'revised' ? `<div class="writing-reading-panel writing-highlight-surface" id="writing-reading-panel" data-highlight-source="revised">${renderEssayHtml(revisedEssay)}</div>` : ''}
    ...
    <div class="writing-main-view">
      ...
      <section class="writing-pane">
        <div class="writing-pane-head">
          ...
          <div class="writing-reading-panel">${renderEssayHtml(record.originalEssay)}</div>
      </section>
      <section class="writing-pane">
        <div class="writing-pane-head">
          <h3>AI 修改结果</h3>
...
function bindSelection(task) {
  ...
  selectionHandler = () => {
    ...
    patchWritingWorkspace(task, {
      ...
      selectionY: Math.max(rect.top - 10, 10)
    });
    updateSelectionPopover(task);
  };
